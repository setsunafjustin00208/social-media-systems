...
<nav class="navbar" id="navbar" role="navigation" aria-label="main navigation" x-data="{ isActive: false }">
    <div class="navbar-brand">
        ...
        <a role="button" class="navbar-burger" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample" @click="isActive = !isActive" :class="{ 'is-active': isActive }">
    ...
    <div id="navbarBasicExample" class="navbar-menu" :class="{ 'is-active': isActive }">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable" x-data="{ isDropdownOpen: false }">
                <a class="navbar-link" @click="isDropdownOpen = !isDropdownOpen">More</a>
                <div 
                    class="navbar-dropdown is-dark" 
        ...
        <div class="navbar-end is-hidden-touch">
            <div class="navbar-item" x-data="{ isUserDropdownOpen: false, isSettingsDropdownOpen: false }">
                <!-- User Icon with Dropdown -->
                <div class="navbar-item has-dropdown is-hoverable" @click.away="isUserDropdownOpen = false">
                    <a href="#" class="navbar-link" @click.prevent="isUserDropdownOpen = !isUserDropdownOpen">
                ...
                <div class="navbar-item has-dropdown is-hoverable" @click.away="isSettingsDropdownOpen = false">
                    <a href="#" class="navbar-link" @click.prevent="isSettingsDropdownOpen = !isSettingsDropdownOpen">
                    ...
                    >
                        <a class="navbar-item">
                            <span class="icon is-small"><i class="fas fa-gears"></i></span>
                            Settings
                        </a>
                        <a class="navbar-item">
